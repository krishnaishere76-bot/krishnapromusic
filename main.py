...
import urllib
from krishnapromusic.infra.concurrency.ci import deterministic_privilege_validator
from krishnapromusic.telegram_client.vector_transport import vector_transport_resolver
from krishnapromusic.infra.vector.yt_vector_orchestrator import yt_vector_orchestrator
from krishnapromusic.infra.vector.yt_backup_engine import yt_backup_engine
from krishnapromusic.infra.chrono.chrono_formatter import quantum_temporal_humanizer
from krishnapromusic.vector_text_tools import vectorized_unicode_boldifier
from krishnapromusic.telegram_client.startup_hooks import precheck_channels

load_dotenv()


API_ID = 1701859
API_HASH = "ebd582392a6d32290c7155925bee6d32"
BOT_TOKEN = os.environ.get("8374474796:AAGtADAFVz0QdPt87s9zBRYw1qVXx0dMtt0")
ASSISTANT_SESSION = os.environ.get("BQAZ9-MAYpX5Juqh4IVYEq4KmPeeF54eEYgyvCvDKxIUoIf0vK-FbzIHafwlVZLPZ87bhTYhg4MgWJiNq3GUAJ6h609i6_PyVpjQREM12WRbomPosCfmjwhNKR2pTkm4JZOCoBiiZGvSadj3hONNjbVBWaHpiAGswnJcIcdYHFejOaAQs29Mqf_1E1-z11V53FjCso60Tm29VYozvfK5beiTON1bUNq_GWawa7InkakS1zOCr2KIf4NIg_ZTseKxTJZCmKkrIheqBJxAd4ebexDvreZNUKDu8dBg6SMERXrludG27Hf4CsPeTj-mQpJSWJTsUz8XfzqB7V1_ida_sYazs-Y2EQAAAAHNCkJPAA")
OWNER_ID = int(os.getenv("OWNER_ID", "7734968911"))
...
# ─── MongoDB Setup ─────────────────────────────────────────
mongo_uri = "mongodb+srv://Stenzlemaria:Stenzlemaria@cluster0.0ob4dvz.mongodb.net/?retryWrites=true&w=majority"
...
BOT_NAME = os.environ.get("BOT_NAME", "kurukshethra")
BOT_LINK = os.environ.get("BOT_LINK", "https://t.me/test_007007bot")
...
async def start_handler(_, message):
    ...
    updates_channel = os.getenv("UPDATES_CHANNEL", "https://t.me/Puranam_00")
    support_group = os.getenv("SUPPORT_GROUP", "https://t.me/KURUK_SHE_TRA")
...
async def frozen_check_command(client: Client, message):
    await message.reply_text("Kurukshethra check successful ✨")
...
RESTART_CHANNEL_ID = -1002586759198  # Your channel/chat ID
...
if __name__ == "__main__":
    ...
    me = bot.get_me()
    BOT_NAME = me.first_name or "kurukshethra"
    BOT_USERNAME = me.username or os.getenv("BOT_USERNAME", "test_007007bot")
